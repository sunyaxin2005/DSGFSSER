...
save_dir_main = 'F:\第8篇论文实验结果\EmoDBtset1\';% The save path of extracted features
...
feature_type = {'MFCC', 'Q', 'TQ', 'LPCC', 'plp', 'RASTA-PLP'};%
...
bw = [50, 60, 60, 60, 40, 40]; % the best frequency resolution of STFT b for 'MFCC', 'Q', 'TQ'
...
%         catch
 ...
 %       dim_stat_typess = [dim_stat_typess, dim_stat_types];
        ...
        if(issave(inx))
            ...
            save(save_stats_path1, 'all_cross_feas', 'stats_dims', 'files_people_label', 'files_emotion_label', 'files_sentence_label');
            all_cross_feas = [];
        end
    end
%     catch
