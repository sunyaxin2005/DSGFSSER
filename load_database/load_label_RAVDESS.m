function [ files_path files_people_label files_emotion_label files_sentence_label words_mark ] = load_label_RAVDESS( wave_files_names, wave_files_path  )
%LOAD_LABEL_DATAS Summary of this function goes here
%   Detailed explanation goes here
load_type = 'load_all';
files_name = cell(length(wave_files_names), 1);
...
for ci = 1:1:load_file_num
    ...
    files_people_label{index} = file_name(19:20);
    files_emotion_label{index} = file_name(7:8);
    files_sentence_label{index} = ci;
