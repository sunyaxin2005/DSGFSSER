...
% Conclude with the analysis of a Finnish folk song, L鋕sin min� kes鋣鰊�, whose excerpt is recorded in the file ?laksin.wav?. As the melody is sung by one voice only, you can use the ?Mono? option in mirpitch.
mirplay('laksin')
