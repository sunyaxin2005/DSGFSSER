function [ W ] = LRGPSSDR_ITER( XL, L, XUL )
%LRGPSSDR_ITER Summary of this function goes here
%   Detailed explanation goes here
[ W1 ] = LRGPSSDR(  XL, L, XUL  );
X =[XL;XUL];
X1 = X * W1(:, 1:floor(size(W1, 1)/2));
